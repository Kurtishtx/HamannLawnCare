  ...
  return (
    <main>
      <section className="hero honey" style={{ paddingBottom: 96 }}>
        <div className="hero-in" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: 880 }}>
          <div>
            ...
            <p className="hero-sub" style={{ margin: '20px auto 26px' }}>Protect your family and pets from biting fleas and ticks. Hamann&rsquo;s powerful outdoor flea &amp; tick treatments break the lifecycle and keep Watauga yards safe — from a local team serving North Texas since 2006.</p>
      ...
      <section className="cta-band">
        <div className="wrap">
          <h2>Keep Watauga Pets &amp; Family Bite-Free</h2>
