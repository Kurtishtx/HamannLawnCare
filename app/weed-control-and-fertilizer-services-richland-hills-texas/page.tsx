  ...
  return (
    <main>
      <section className="hero honey" style={{ paddingBottom: 96 }}>
        <div className="hero-in" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: 880 }}>
          <div>
            ...
            <p className="hero-sub" style={{ margin: '20px auto 26px' }}>Kill the weeds, feed the grass. Hamann&rsquo;s science-based weed control and fertilization program gives Richland Hills lawns a thick, green, weed-free look year-round — engineered for North Texas turf since 2006.</p>
      ...
      <section className="cta-band">
        <div className="wrap">
          <h2>Give Richland Hills The Best Lawn On The Block</h2>
