  ...
  return (
    <main>
      ...
      <section className="cta-band">
        <div className="wrap">
          <h2>Get Professional Flea &amp; Tick Control Today</h2>
          <p>Protect your family, your pets, and your yard with flea and tick control that actually works. <b>Claim your 50% off first application!</b></p>
          <div className="btns">
