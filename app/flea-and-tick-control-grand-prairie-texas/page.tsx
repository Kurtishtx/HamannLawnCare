...
const points = [{"ic":"🎯","t":"Targeted Outdoor Treatment","d":"We treat the shaded areas, pet zones, and high-risk spots in your Grand Prairie yard where fleas and ticks actually live."},{"ic":"🔄","t":"Breaks the Lifecycle","d":"Our treatments eliminate adult fleas and ticks while disrupting eggs and larvae so they can't keep coming back."},{"ic":"🐶","t":"Protects Pets & Family","d":"Keep the people and animals you love safe from itchy, disease-carrying pests."},{"ic":"📅","t":"Monthly Protection","d":"Recurring treatments provide the best long-term control, especially for homes with pets."},{"ic":"✅","t":"Safe Once Dry","d":"Professional products applied at safe, label-correct rates — pets return once dry."},{"ic":"📍","t":"Local Since 2006","d":"Family-owned and protecting Grand Prairie yards for nearly 20 years."}];
const faqs = [{"q":"How long do flea & tick treatments last?","a":"Most treatments last 30 days. For active infestations or multi-pet households, monthly recurring treatments provide the best control."},{"q":"Is it safe for pets?","a":"Yes. Our products are designed for outdoor use around pets when applied correctly — keep pets off until dry."},{"q":"Do you treat indoors?","a":"We provide outdoor flea & tick control. For indoor infestations, pair our service with a licensed indoor treatment."},{"q":"How soon will I see results in Grand Prairie?","a":"Most customers notice a reduction in flea and tick activity within 24–48 hours, with continued improvement after each treatment."}];
  ...
  return (
    <main>
      <section className="hero honey" style={{ paddingBottom: 96 }}>
        <div className="hero-in" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: 880 }}>
          <div>
            ...
            <p className="hero-sub" style={{ margin: '20px auto 26px' }}>Protect your family and pets from biting fleas and ticks. Hamann&rsquo;s powerful outdoor flea &amp; tick treatments break the lifecycle and keep Grand Prairie yards safe — from a local team serving North Texas since 2006.</p>
      ...
      <section className="cta-band">
        <div className="wrap">
          <h2>Keep Grand Prairie Pets &amp; Family Bite-Free</h2>
