      ...
      <section className="hero honey" style={{ paddingBottom: 90 }}>
        <div className="hero-in" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: 780 }}>
          <div>
            ...
            <h1><span className="headline-3d">Lawn Care Pricing</span></h1>
            <p className="hero-sub" style={{ margin: '20px auto 26px' }}>Pricing is based on your lawn square footage. Measure around the house, fence, and beds — or just call and we&rsquo;ll measure it for you. Call or text for your exact price &mdash; and claim 50% off your first application.</p>
      ...
      <section>
        <div className="wrap" style={{ maxWidth: 760 }}>
          ...
          <div className="svc-grid" style={{ gridTemplateColumns: 'repeat(auto-fit,minmax(230px,1fr))' }}>
            <div className="svc-card"><div className="svc-top" /><div className="svc-ic">📏</div><h3>Based On Your Yard</h3><p>Your price is based on the size of your property and the lawn care & weed control you need &mdash; no guesswork.</p></div>
          ...
          <p style={{ textAlign: 'center', marginTop: 30 }}><a href="/lawn-care-services" style={{ color: 'var(--orange-dk)', fontWeight: 800 }}>Learn more about our lawn care & weed control &rarr;</a></p>
        </div>
      </section>
