...
const points = [{"ic":"🏆","t":"Golf-Course-Grade Products","d":"The same premium technology trusted by golf courses — longer protection with fewer applications for Arlington yards."},{"ic":"⚡","t":"Fast-Acting Knockdown","d":"We reduce active mosquito populations within hours — not days — so you can enjoy your yard again fast."},{"ic":"🛡️","t":"Long-Lasting Barrier","d":"Our residual barrier keeps working for weeks, stopping new mosquitoes from taking over your Arlington property."},{"ic":"🗓️","t":"Just 7 Visits a Year","d":"While competitors spray every 21 days, we protect you with 7 stronger applications spaced every 5–6 weeks."},{"ic":"✅","t":"Safe for Family & Pets","d":"Applied with professional equipment and safe for kids and pets once dry."},{"ic":"📍","t":"Local Since 2006","d":"Family-owned and treating Arlington and North Texas yards for nearly 20 years."}];
const faqs = [{"q":"How long do mosquito treatments last?","a":"Around 45 days depending on weather and mosquito pressure."},{"q":"Is it safe for pets?","a":"Yes — once dry, pets and children can return to treated areas."},{"q":"Do you offer recurring mosquito control in Arlington?","a":"Yes. For consistent season-long protection, our recurring program treats every 5–6 weeks from spring through fall."},{"q":"Does it help with other pests?","a":"Yes — it also reduces gnats, no-see-ums, and other biting insects."}];
  ...
  return (
    <main>
      <section className="hero honey" style={{ paddingBottom: 96 }}>
        <div className="hero-in" style={{ gridTemplateColumns: '1fr', textAlign: 'center', maxWidth: 880 }}>
          <div>
            ...
            <p className="hero-sub" style={{ margin: '20px auto 26px' }}>Take your backyard back. Hamann delivers premium, long-lasting mosquito control for Arlington homes — golf-course-grade products, fewer applications, and a local crew that&rsquo;s treated North Texas yards since 2006.</p>
      ...
      <section className="cta-band">
        <div className="wrap">
          <h2>Arlington&rsquo;s Mosquitoes Don&rsquo;t Stand A Chance</h2>
